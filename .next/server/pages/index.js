...
async function getStaticProps() {
  // fetch data from API
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://bassil_alqadi97:bassa11223344551997@cluster0.l1xcsxw.mongodb.net/meetups?retryWrites=true&w=majority");
  const db = client.db();
